...
node_keys = { "addr:housenumber","aerialway","aeroway","amenity","barrier","highway","historic","emergency","leisure","natural","office","place","railway","shop","sport","tourism","waterway" }
...
landcoverKeys   = { wood="wood", forest="wood",
                    ...
                    farmland="farmland", farm="farmland", orchard="farmland", vineyard="vineyard", plant_nursery="farmland",
...
poiTags         = { aerialway = Set { "station" },
					...
					historic = Set { "monument", "castle", "ruins", "wayside_cross", "wayside_shrine" },
					emergency = Set { "defibrillator", "fire_hydrant" },
...
poiClasses      = { townhall="town_hall", public_building="town_hall", courthouse="town_hall", community_centre="town_hall",
					...
					wayside_cross="wayside_cross", wayside_shrine="wayside_shrine", defibrillator="defibrillator", fire_hydrant="fire_hydrant" }
...
poiKeys         = Set { "amenity", "sport", "tourism", "office", "historic", "emergency", "leisure", "landuse", "information" }
...
function way_function(way)
	...
	local emergency = way:Find("emergency")
	...
	if highway~="" then
		...
		if minzoom <= 14 then
			...
			if way:Find("lit")=="yes" then way:AttributeNumeric("lit", 1) else way:AttributeNumeric("lit", 0) end
		end
	end
